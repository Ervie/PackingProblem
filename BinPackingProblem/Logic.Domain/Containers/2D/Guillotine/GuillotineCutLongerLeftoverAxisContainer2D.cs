...
{
	public class GuillotineCutLongerLeftoverAxisContainer2D : GuillotineCutContainer2D
	{
		public GuillotineCutLongerLeftoverAxisContainer2D(int width, int height) : base(width, height)
		{
		}
