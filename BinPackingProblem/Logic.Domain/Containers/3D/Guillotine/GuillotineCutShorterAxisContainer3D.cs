...
{
	public class GuillotineCutShorterAxisContainer3D : GuillotineCutContainer3D
	{
		public GuillotineCutShorterAxisContainer3D(int width, int height, int depth) : base(width, height, depth)
		{
		}
