...
{
	public class GuillotineCutShorterLeftoverAxisContainer3D : GuillotineCutContainer3D
	{
		public GuillotineCutShorterLeftoverAxisContainer3D(int width, int height, int depth) : base(width, height, depth)
		{
		}
