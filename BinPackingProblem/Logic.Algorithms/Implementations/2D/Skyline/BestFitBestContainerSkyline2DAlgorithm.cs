...
{
	public class BestFitBestContainerSkyline2DAlgorithm : AbstractSkylineBestFit2DAlgorithm
	{
		public BestFitBestContainerSkyline2DAlgorithm(Container2D initialContainer) : base(initialContainer)
		{
		}
