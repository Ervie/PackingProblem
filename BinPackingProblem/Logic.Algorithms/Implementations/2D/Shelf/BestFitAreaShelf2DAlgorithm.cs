...
{
	public class BestFitAreaShelf2DAlgorithm : AbstractBestFitShelf2DAlgorithm
	{
		public BestFitAreaShelf2DAlgorithm(Container2D initialContainer) : base(initialContainer)
		{
		}
		...
		protected override double CalculateFitResult(Object2D objectToPlace, int widthLeftInShelf, int shelfLevel, int shelfHeight, int containerWidth, int ContainerHeight)
		{
			...
			else
			{
				...
				return (double) availableArea / objectToPlace.Area;
			}
		}
	}
}
