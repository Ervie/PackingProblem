...
{
	public class WorstFitWidthShelf2DAlgorithm : AbstractBestFitShelf2DAlgorithm
	{
		public WorstFitWidthShelf2DAlgorithm(Container2D initialContainer) : base(initialContainer)
		{
		}
